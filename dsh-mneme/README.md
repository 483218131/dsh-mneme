...
[![tests](https://img.shields.io/badge/tests-1330%20passed-success)](https://github.com/slow-stack/mneme)
...
test/                 # 1330 个 node:test 测试（审计与三轴线压测不变量；src↔lib 一致性由 scripts/check-sync.js 发布闸门校验）
